...
def login_form():
    ...
    with st.form("login_form"):
        ...
        if submit_button:
            # Verifica se st.secrets está disponível e tem as chaves esperadas
            if "login" in st.secrets and \
               "username" in st.secrets["login"] and \
               "password" in st.secrets["login"]:
